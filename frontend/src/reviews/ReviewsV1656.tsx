...
function ReviewCard({
  ...
  return (
    <article className="reviews-v1656__card">
      ...
      {review.owner_reply ? (
        <div className="reviews-v1656__owner-reply">
...
export function PublicReviewsV1656({ api, targetKind, targetPublicId }: PublicProps) {
  ...
  if (!data && !error) {
    return <div className="reviews-v1656__loading">Fikrlar yuklanmoqda...</div>;
  }
  ...
  return (
    <section className="reviews-v1656 public-reviews-v1656">
      ...
      {data?.count ? (
        ...
        <div className="reviews-v1656__muted">Hali baho yo‘q</div>
      )}

      {data?.can_review ? (
        <div className="reviews-v1656__form">
          <b>{data.my_review ? "Bahoyingizni o‘zgartiring" : "Baho bering"}</b>
          <div className="reviews-v1656__star-input">
            {[1, 2, 3, 4, 5].map((star) => (
              <button
...
function OwnerReviewCard({
  ...
  return (
    <div>
      ...
      <div className="reviews-v1656__reply-form">
        <textarea
          maxLength={1500}

...
describe("modular public E'lonlar", () => {
  ...
  it("keeps the exact modular empty-category text", async () => {
    const user = userEvent.setup();
    render(
      <PublicListings
        api={{
  ...
  it("opens listing photos in the modular media viewer", async () => {
    const user = userEvent.setup();
    render(
      <ListingDetail
        listing={listing}
  ...
  it("keeps the standalone modular listing detail surface", async () => {
...
describe("modular owner E'lonlar", () => {
...
describe("modular saved E'lonlar", () => {

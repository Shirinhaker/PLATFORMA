...
export function MyQueues({
  ...
  return (
    <section className="my-queues-modular" aria-label="Mijoz navbatlari">
      <div className="my-queues-modular__heading">
        <h2>📋 Navbatlar</h2>
        <span>{rows.length} ta</span>
      </div>
      {error ? <p className="my-queues-modular__message" role="alert">{error}</p> : null}
      {notice ? <p className="my-queues-modular__message" role="status">{notice}</p> : null}
      {loading ? (
        <div className="idesc">Yuklanmoqda...</div>
      ) : rows.length ? (
        <div className="my-queues-modular__list">
          {rows.map((queue) => {
            ...
            return (
              ...
              >
                <div className="my-queues-modular__top">
                  <div>
                ...
                <div className="my-queues-modular__details">
        ...
        <div className="idesc my-queues-modular__empty">
          Hozircha xizmat navbati olinmagan.
        </div>
      )}
      {cancelTarget ? (
        <div className="my-queues-modular__backdrop">
          <section
            aria-label="Navbatni bekor qilish"
            aria-modal="true"
            className="my-queues-modular__confirm"
            role="dialog"
          >

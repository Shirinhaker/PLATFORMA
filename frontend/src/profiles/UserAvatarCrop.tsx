...
export function UserAvatarCrop({
  ...
  return (
    <section className="user-avatar-crop-modular" aria-label="Rasm joylashuvini sozlash">
      <div
        ref={stage}
        className="user-avatar-crop-modular__stage"
        onPointerDown={begin}
        onPointerMove={move}
        onPointerUp={stop}
      ...
      <div className="user-avatar-crop-modular__actions">
        <button
          type="button"

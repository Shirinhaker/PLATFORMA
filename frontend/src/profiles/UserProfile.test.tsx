...
describe("modular user cabinet and profile parity", () => {
  ...
  it("renders the exact modular dashboard labels and descriptions", async () => {
    render(
      <UserProfile
        api={profileApi()}
        identity={identity}
  ...
  it("renders the modular profile card, fields and local share QR", async () => {
    const user = userEvent.setup();
    render(
      <UserProfile
        api={profileApi()}

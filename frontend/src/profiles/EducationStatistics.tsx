...
import "./EducationStatistics.css";
...
function Metric({
  ...
  return (
    <article className="education-statistics-modular__metric">
      <small>{label}</small>
...
export function EducationStatistics({
  ...
  return (
    <main className="education-statistics-modular">
      <header className="education-statistics-modular__heading">
      ...
      <section className="education-statistics-modular__intro">
        <b>Ta'lim boshqaruv paneli</b>
        <p>O'quv jarayoni va moliyaviy natijalar bitta joyda.</p>
      </section>

      <nav className="education-statistics-modular__periods" aria-label="Ta'lim statistikasi davri">
        {PERIODS.map((option) => (
          <button
            type="button"
            key={option.key}
      ...
      <nav className="education-statistics-modular__navigation" aria-label="Davr navigatsiyasi">
        <button
          type="button"
      ...
      {error ? <p className="education-statistics-modular__error" role="alert">{error}</p> : null}
      {loading ? <p className="education-statistics-modular__loading">Statistika yuklanmoqda...</p> : null}

      {!loading && data ? (
        <div className="education-statistics-modular__content">
          <section>
            <h2>Ta'lim jarayoni</h2>
            <div className="education-statistics-modular__grid">
          ...
          <section>
            ...
            {data.groups.length ? (
              <div className="education-statistics-modular__groups">
              ...
              <div className="education-statistics-modular__empty">
                <h3>Guruhlar yo'q</h3>

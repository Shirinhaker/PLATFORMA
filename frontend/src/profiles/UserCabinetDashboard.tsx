...
import { avatarImageStyle } from "./UserAvatarCrop";
...
/* static/index.html modular dagi orderIsActive bilan aynan bir xil statuslar. */
...
function userNotificationVisible(value: unknown) {
  ...
  /*
   * modular /api/notifications?actor_type=user actor_kind=user ni ajratadi.
...
export function UserCabinetDashboard({
  ...
  return (
    <main className="user-cabinet-modular">
      <section className="user-cabinet-modular__shell">
        <header className="user-cabinet-modular__identity">
          <button
            type="button"
            className="user-cabinet-modular__avatar"
          ...
          <div>
            ...
            <div className="user-cabinet-modular__follow">
        ...
        <div className="user-cabinet-modular__metrics" aria-label="Kabinet statistikasi">
        ...
        <div className="user-cabinet-modular__main">
          <section className="user-cabinet-modular__menu-panel">
            <header className="user-cabinet-modular__panel-title">
              <h2>Mening bo‘limlarim</h2>
              <span>Profil va faoliyatlar</span>
            </header>
            <div className="user-cabinet-modular__menu">
            ...
            <button
              type="button"
              className="user-cabinet-modular__business"
              disabled={busy}
            ...
            {error ? <p className="user-cabinet-modular__error" role="alert">{error}</p> : null}
          </section>

          <aside className="user-cabinet-modular__activity">
            <header className="user-cabinet-modular__panel-title">
              <h2>So‘nggi faollik</h2>
              <span>{recentActivity.length} ta</span>
            </header>
            {!recentActivity.length ? (
              <div className="user-cabinet-modular__empty">
                <strong>Hozircha faollik yo‘q</strong>
                <p>Yangi buyurtma yoki xizmat paydo bo‘lsa, shu yerda ko‘rinadi.</p>
              </div>
            ) : (
              <div className="user-cabinet-modular__activity-list">

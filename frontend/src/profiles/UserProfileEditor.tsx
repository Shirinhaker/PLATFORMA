...
function QrCode({ value }: { value: string }) {
  ...
  return (
    <div
      ref={root}
      className="user-profile-share-modular__qr"
...
export function UserProfileEditor({
  ...
  return (
    <main className="user-profile-editor-modular">
      <header className="user-profile-editor-modular__head">
        <button type="button" aria-label="Kabinetga qaytish" onClick={onBack}>‹</button>
        <h1>Profilim</h1>
      </header>

      <section className="user-profile-card-modular">
        <button
          type="button"
          className="user-profile-card-modular__avatar"
        ...
        <div className="user-profile-card-modular__main">
        ...
        <button
          type="button"
          className="user-profile-card-modular__camera"
      ...
      {draft.avatar_url ? (
        <button
          type="button"
          className="btn btn-outline btn-block user-profile-editor-modular__adjust"
      ...
      <form className="user-profile-form-modular" onSubmit={save}>
        <label>
          Ism familiya
          <input
            className="input"
        ...
        <label>
          ...
          <span className="user-profile-form-modular__username">
            <b>@</b>
            <input
              className="input"
        ...
        <section className="user-profile-share-modular">
      ...
      {lightbox && draft.avatar_url ? (
        <button
          type="button"
          className="user-profile-lightbox-modular"

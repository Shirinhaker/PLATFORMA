...
// modular `notifyTime`: bugungi vaqt soat:daqiqa, aks holda kun.oy.
...
export function BusinessKitchen({
  api,
  permissions,
  onBackHandlerChange,
}: Props) {
  ...
  // modular: bo'lim tanlanmagan bo'lsa, bo'sh bo'lmaganiga o'tadi.

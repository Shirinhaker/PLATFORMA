...
describe("kassa — ovqatlanish bo'limlari (modular pariteti)", () => {
  ...
  it("uchta bo'lim modular nomlari bilan", async () => {
  ...
  it("ochiq hisob kartasi va amallar ko'rinadi", async () => {
    ...
    // modular dagidek hisob yopiq turadi; kassir uni ochadi.

...
describe("PublicHeader", () => {
  ...
  it("renders the exact modular public actions and feature gates", async () => {
  ...
  it("caps the modular cart badge at 99+", () => {
    const actions = {
  ...
  it("uses the exact modular moon and sun icons for the current theme", () => {

...
describe("modular-compatible home location storage", () => {
  ...
  it("preserves the exact saved map center used by the modular Home map", () => {
  ...
  it("writes the exact modular schema under its versioned key", () => {
    const setItem = vi.fn();

...
export function SpecialistV1656({ api, onBack, onReviews }: Props) {
  ...
  if (!profile) {
    return <main className="specialist-v1656"><p>Yuklanmoqda...</p></main>;
  }
      ...
      <main className="specialist-v1656">
        ...
        <form className="specialist-v1656__form" onSubmit={saveOffer}>
          ...
          {offerImageUrl ? (
            ...
            <label className="specialist-v1656__photo-add" htmlFor="specialist-offer-image">
          ...
          {error ? <p className="specialist-v1656__error" role="alert">{error}</p> : null}
          <button className="specialist-v1656__primary" disabled={busy} type="submit">Saqlash</button>
          {offerId ? (
            <button
  ...
  return (
    <main className="specialist-v1656">
      <header className="specialist-v1656__toolbar">
        ...
        {onReviews ? (
          <button className="specialist-v1656__reviews" type="button" onClick={onReviews}>
      ...
      <div className="specialist-v1656__form">
        ...
        <section className="specialist-v1656__section">
          ...
          <div className="specialist-v1656__rail">
            <button className="specialist-v1656__add-card" type="button" onClick={() => editOffer()}>
              <span>+</span>Xizmat yoki mahsulot qo‘shish
            </button>
            {profile.offers.map((item) => (
              <button className="specialist-v1656__offer-card" key={item.id} type="button" onClick={() => editOffer(item)}>
                <div className="specialist-v1656__offer-image">{item.image_url ? <img alt="" src={item.image_url} /> : item.kind === "product" ? "📦" : "🧰"}</div>
        ...
        {error ? <p className="specialist-v1656__error" role="alert">{error}</p> : null}
        {saved ? <p className="specialist-v1656__success" role="status">Saqlandi ✅</p> : null}
        <button

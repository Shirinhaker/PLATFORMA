...
export function TaxiCall({
  ...
  useEffect(() => {
    ...
    const icon = module.divIcon({
      className: "taxi-call-modular__origin-icon",
  ...
  return (
    <main className="screen active taxi-call-modular" data-screen="taxi-call">
      <div className="taxi-call-modular__shell">
        <section className="call-panel" id="callPanel">
          {phase === "search" ? (
            <div className="panel-card taxi-call-modular__centered">
            ...
            <div className="panel-card">
              ...
              <div className="sort-row taxi-call-modular__tabs">
              ...
              <div className="field">
                <span className="taxi-call-modular__field-label">Qayerdan{pickMode === "from" ? <em> — xaritani suring</em> : null}</span>
                <div className="taxi-call-modular__from-row">
                  <button className={`input taxi-call-modular__input-button${pickMode === "from" ? " is-active" : ""}`} type="button" onClick={() => choosePick("from")}>{fromAddr}</button>
                  <button aria-label="Joriy joylashuvni olish" className="taxi-call-modular__gps" type="button" onClick={() => requestCurrentLocation(true)}>📍 GPS</button>
                </div>
              </div>
              <div className="field">
                <span className="taxi-call-modular__field-label">Qayerga{pickMode === "to" && !ozim ? <em> — xaritani suring</em> : null}</span>
                <button disabled={ozim} className={`input taxi-call-modular__input-button${pickMode === "to" && !ozim ? " is-active" : ""}`} type="button" onClick={() => choosePick("to")}>{toAddr || "Bu maydonni tanlab xaritani suring"}</button>
              </div>
              <button className={`sort-chip taxi-call-modular__say-it${ozim ? " on" : ""}`} type="button" onClick={() => {
              ...
              {kind === "dostavka" ? (
                <>
                  <fieldset className="field taxi-call-modular__vehicle-field">
                    <legend>Mashina turi</legend>
                    <div className="taxi-call-modular__vehicle-options">
                  ...
                  <label className="field taxi-call-modular__cargo-field">
                    <span className="taxi-call-modular__field-label">Yuk turi</span>
        ...
        <div className="taxi-call-modular__map-wrap">
          <div className="taxi-call-modular__map" id="taxiCallMap" ref={mapHost} />
          {phase === "form" ? <div className="taxi-call-modular__center-pin">📍</div> : null}
          {district ? <div className="taxi-call-modular__map-chip">⌾ {district}</div> : null}
          <button aria-label="Taxi oynasidan chiqish" className="taxi-call-modular__map-action" type="button" onClick={onBack}>🚖</button>
        </div>
      </div>
    </main>
  );
...
function DriverCard({ ride, onCancel }: { ride: TaxiRide; onCancel(): void }) {
  ...
  return (
    <div className="panel-card taxi-call-modular__driver-card" id="driverCard">
      <div className="taxi-call-modular__driver-row">
        ...
        <div>
          ...
          {cost ? <div className="list-sub taxi-call-modular__price">💰 ~{money(cost)} so'm (naqd)</div> : null}
          {ride.ozim ? <div className="list-sub">Manzilni og'zaki aytasiz</div> : null}
        </div>
      </div>
      <div className="taxi-call-modular__actions">

...
describe("DriverCabinet", () => {
  it("keeps the form controls self-contained inside the modular driver screen", () => {
    const css = readFileSync("src/taxi/taxi.css", "utf8");

    expect(css).toContain(".taxi-driver-modular .field");
    expect(css).toContain(".taxi-driver-modular .input");
    expect(css).toContain(".taxi-driver-modular .sort-chip");
    expect(css).toContain(".taxi-driver-modular .panel-card");
    expect(css).toContain(".taxi-driver-modular .btn-primary");
    expect(css).toContain(".taxi-driver-modular .vis-card");
  });

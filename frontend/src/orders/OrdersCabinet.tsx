        ...
        <main className="order-detail-sheet on">
          ...
          {selected.status !== "new" && hasPaymentData ? (
            <section className="panel-card order-payment-v1656">
              ...
              {side === "provider" ? (
                <div className="idesc">
                  Mijoz chek (to'lov skrinshoti)ni suhbatga tashlaydi. Tekshirib
                  tasdiqlang.
                </div>
              ) : null}
              {side === "customer" &&
              ...
              {side === "customer" && canSubmitPayment ? (
                <div className="idesc">
                  ...
                  (Click/Payme/bank) oching va o'tkazing. So'ng kvitansiya (chek)
                  rasmini yuboring.
                </div>
              ) : null}
              ...
              <div className="order-action-row">
                ...
                {canSubmitPayment ? (
                  <button
                    ...
                    disabled={busy}
                    onClick={() =>
                      void mutate(() => api.submitOrderPayment(selected.id))
                    }
                  >
                    ✅ To'lov qildim
                  </button>
                ...
                ["submitted", "recheck", "disputed"].includes(
                  ...
                  <button
                    ...
                    className="btn btn-primary btn-block"
                    disabled={busy}
                    onClick={() => setConfirmation("payment-confirm")}
                  >
                    ✅ To'lovni tasdiqlash
                  </button>
                ) : null}
                ...
                <div className="order-action-row">
                  {(
                    ...
                    <button
                      ...
                      onClick={() =>
                        void mutate(() =>
                          api.chooseOrderProblemSolution(selected.id, solution),
                        )
                      }
                    >
                      {label}
            ...
            <section className="panel-card order-status-actions">
              ...
              {side === "provider" && selected.status === "accepted" ? (
                <button
                  ...
                  disabled={busy}
                  onClick={() => setDebtPickerOpen(true)}
                >
              ...
              {side === "provider" && selected.status === "preparing" ? (
                <button
                  ...
                  className="mini-btn ok"
                  disabled={busy}
                  onClick={() => void changeStatus("tayyor")}
                >
                  ✅ Buyurtma tayyor
                </button>
              ) : null}
              ...
              {side === "provider" && selected.status === "handoff_waiting_seller" ? (
                <button
                  type="button"
                  className="mini-btn ok"
                  onClick={() => setConfirmation("handoff")}
                >
              ...
              ["delivered_waiting_customer", "pickup_waiting_customer"].includes(
                ...
                <button
                  type="button"
                  className="mini-btn ok"
                  onClick={() => setConfirmation("received")}
                >
          ...
          <section className="panel-card order-chat-box">
            ...
            <div className="order-chat-send">
              ...
              />
              <button type="button" disabled={busy} onClick={() => void sendMessage()}>
            ...
            <div className="order-chat-action-menu on">
              ...
              {messageMenu.mine && messageMenu.text.trim() ? (
                <button
                  type="button"
                  onClick={() => {
                    setEditing(messageMenu);
                    setReplyTo(null);
                    setText(messageMenu.text);
                    setPendingImage(null);
                    setMessageMenu(null);
                  }}
                >
              ...
              {messageMenu.mine ? (
                <button
                  ...
                  className="danger"
                  onClick={() => {
                    setDeleteTarget(messageMenu);
                    setConfirmation("delete-message");
                    setMessageMenu(null);
                  }}
                >
                  🗑 O‘chirish
          ...
          {photoUrl ? (
            <div
              ...
              onClick={(event) => {
                if (event.currentTarget === event.target) setPhotoUrl("");
              }}
            >
              <button
                type="button"
            ...
            <div className="order-confirm-backdrop">
              ...
              >
                ...
                <div className="lead-sub">
                  Sababni tanlang. Muammo hal bo'lmaguncha tayyorlash, dostavka va
                ...
                <label>
                  ...
                  <select
                    value={problemReason}
                    onChange={(event) =>
                      setProblemReason(event.currentTarget.value as OrderProblemReason)
                    }
                  >
                ...
                <div className="order-card-actions">
                  {["submitted", "recheck", "disputed"].includes(
                    ...
                    <button
                      ...
                      onClick={(event) => {
                        event.stopPropagation();
                        void openDetail(order).then(() => setProblemOpen(true));
                      }}
                    >
                      ⚠️ To'lov muammosi
                    </button>

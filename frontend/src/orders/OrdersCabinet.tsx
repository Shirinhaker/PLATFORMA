...
export function OrdersCabinet({
  ...
  if (selected) {
    ...
    return (
      ...
      <main className="order-detail-sheet on">
        ...
        <section className="panel-card order-receipt-modular">
        ...
        {selected.status !== "new" && hasPaymentData ? (
          <section className="panel-card order-payment-modular">
            <b>💳 Onlayn to'lov</b>
        ...
        {selected.problem_open ? (
          <section className="panel-card order-problem-modular">
  ...
  return (
    <main className="orders-cabinet-modular">
      <header className="orders-modular-heading">

...
import { findLocationCenter } from "../public/location-centers";
import type { HomeLocation } from "../public/location-storage";
...
export function Cart({
  ...
  return (
    <main className="screen active cart-modular" data-screen="cart">

...
export function StoryViewer({
  ...
  return (
    <div aria-label="Istoriya ko‘ruvchisi" aria-modal="true" className="story-viewer-modular" role="dialog">
      <div className="story-viewer__panel">
        ...
        {error ? <p className="story-modular__error" role="alert">{error}</p> : null}
      </div>
    </div>
  );
}

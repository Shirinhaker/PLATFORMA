...
import { PublicProfileItems } from "./PublicProfileItems";
    ...
    >
      ...
      {business && profile.items.length ? (
        <section className="public-profile-section">
          ...
          <PublicProfileItems groups={groups} focusItemPublicId={focusItemPublicId} focusItemRef={focusItemRef} education={education} queueSupported={queueSupported} itemAction={itemAction} />
        </section>
      ) : null}

...
export function BusinessOpening({
  api,
  onBack,
  onSwitch,
  onOpened,
  ...
  if (result) {
    return (
      <main className="business-opening-modular">
        <section className="business-opening-modular__card business-opening-modular__success">
          <span className="business-opening-modular__success-icon" aria-hidden="true">✓</span>
          <h1>Biznes ochildi! ✅</h1>
          <p>
            Biznes kabinetingiz uchun alohida login va parol. Saqlab qo'ying —
            Telegramingizga ham yuborildi.
          </p>
          <dl className="business-opening-modular__credentials">
            <div>
              <dt>🏪 Biznes login</dt>
          ...
          <button
            type="button"
            className="business-opening-modular__primary"
  ...
  return (
    <main className="business-opening-modular">
      <section className="business-opening-modular__card">
        <button
          type="button"
          className="business-opening-modular__back"
          onClick={onBack}
        >
          ← Kabinetga qaytish
        </button>
        ...
        <form onSubmit={submit} noValidate>
          ...
          <div className="business-opening-modular__row">
            <label>
              <span>Yo'nalish</span>
              <select
          ...
          {error && <p className="business-opening-modular__error" role="alert">{error}</p>}
          <button
            type="submit"
            className="business-opening-modular__primary"
            disabled={busy}

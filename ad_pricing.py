...
def shift_schedule_start(
    *,
    ...
    # Kun bo'yi reklama tasdiqlanganda keyingi 00:00 ni kutmaydi.
    # Tasdiq vaqti yangi start bo'ladi, shunda to'langan to'liq muddat
    # aynan tasdiqdan boshlab ishlaydi.

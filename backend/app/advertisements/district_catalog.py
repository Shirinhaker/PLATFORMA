"""O'zbekiston viloyat/tuman katalogi.

v1656 `district_catalog.py` dan aynan ko'chirilgan — reklama narxi
shu ro'yxatdagi tumanlar soniga qarab hisoblanadi, shuning uchun
ikkala tomonda bir xil bo'lishi shart.
"""

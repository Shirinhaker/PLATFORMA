"""Reklama joylash sxemalari — reklama egasining kabineti uchun.

Public sxemalar `schemas.py` da qoladi: u fayl public kontrakt sifatida
tekshiriladi va unda saqlash kalitlari (`*_object_key`) bo'lmasligi
shart. Bu yerdagi maydonlar esa faqat egasiga ko'rinadi — rasm
grant orqali yuklanib, kaliti shu yerda qaytariladi (chek bilan bir xil
naqsh).
"""

...
ROLLBACK_SERVICES = (
    ...
    ("app.admin.moderation", "AdminModerationService"),
    ...
    ("app.auth.service_parts", "AuthService"),
    ("app.business_opening.service", "BusinessOpeningService"),
    ("app.cash_register.service_parts", "CashRegisterService"),
    ("app.catalog.service", "CatalogService"),
    ("app.debt_ledger.service", "DebtLedgerService"),
    ("app.dining.service_parts", "DiningService"),
    ("app.documents.service_parts", "DocumentService"),
    ("app.education.management", "EducationManagementService"),
    ("app.education.service", "EducationEnrollmentService"),
    ("app.expenses.service", "ExpenseService"),
    ("app.follows.service", "FollowService"),
    ("app.inventory.service_parts", "InventoryService"),
    ("app.listings.service", "ListingService"),
    ("app.orders.service_parts", "OrderService"),
    ("app.payments.service_parts", "PaymentService"),
    ("app.profiles.summary_service", "ProfileSummaryService"),
    ("app.public_discovery.service", "PublicDiscoveryService"),
    ("app.queues.service_parts", "QueueService"),
    ("app.staff.service_parts", "StaffService"),
    ("app.stories.service_parts", "StoryService"),
    ("app.specialists.service", "SpecialistService"),
    ("app.ai_assistant.service", "AIAssistantService"),
    ("app.taxi.service_parts", "TaxiService"),
)
